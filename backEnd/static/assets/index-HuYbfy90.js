import{B as o,l as r,a as u,k as i,Y as e,m as d}from"./index-D39o__6r.js";var a=function(t){var n=t.dt;return`
.p-inputgroup {
    display: flex;
    align-items: stretch;
    width: 100%;
...
`)},l={root:"p-inputgroup"},c=o.extend({name:"inputgroup",theme:a,classes:l}),s={name:"BaseInputGroup",extends:r,style:c,provide:function(){return{$pcInputGroup:this,$parentInstance:this}}},g={name:"InputGroup",extends:s,inheritAttrs:!1};function b(p,t,n,f,m,h){return u(),i("div",d({class:p.cx("root")},p.ptmi("root")),[e(p.$slots,"default")],16)}g.render=b;export{g as default};
